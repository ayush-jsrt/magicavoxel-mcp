...
def test_paste_vox_buffer_basic():
    ...
    count, size = paste_vox_buffer(master, prop, offset_x=5, offset_y=5, offset_z=0)
    assert count == 64
...
def test_paste_vox_buffer_with_rotation():
    ...
    count, size = paste_vox_buffer(master, prop, offset_x=2, offset_y=2, offset_z=0, rotation=90)
    assert count == 160
...
def test_paste_vox_buffer_clipping():
    ...
    count, size = paste_vox_buffer(master, prop, offset_x=8, offset_y=8, offset_z=8)
